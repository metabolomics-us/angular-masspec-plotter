import { ɵɵdirectiveInject, ElementRef, Renderer2, ɵɵdefineComponent, ɵɵNgOnChangesFeature, ɵɵelementStart, ɵɵelement, ɵɵelementEnd, ɵsetClassMetadata, Component, Input, ɵɵdefineNgModule, ɵɵdefineInjector, ɵɵsetNgModuleScope, NgModule } from '@angular/core';

class MasspecPlotterLibComponent {
...
MasspecPlotterLibComponent.ɵfac = function MasspecPlotterLibComponent_Factory(t) { return new (t || MasspecPlotterLibComponent)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Renderer2)); };
MasspecPlotterLibComponent.ɵcmp = ɵɵdefineComponent({ type: MasspecPlotterLibComponent, selectors: [["lib-masspec-plotter-lib"]], inputs: { spectrum: "spectrum", miniPlot: "miniPlot", pmzMax: "pmzMax", truncate: "truncate" }, features: [ɵɵNgOnChangesFeature], decls: 2, vars: 0, consts: [[2, "width", "100%", "height", "100%", "display", "inline-block"], [1, "masspec", 2, "width", "100%", "height", "100%"]], template: function MasspecPlotterLibComponent_Template(rf, ctx) { if (rf & 1) {
        ɵɵelementStart(0, "div", 0);
        ɵɵelement(1, "div", 1);
        ɵɵelementEnd();
    } }, encapsulation: 2 });
/*@__PURE__*/ (function () { ɵsetClassMetadata(MasspecPlotterLibComponent, [{
        type: Component,
        args: [{
  ...
  `
    ...
    }], function () { return [{ type: ElementRef }, { type: Renderer2 }]; }, { spectrum: [{
            type: Input
        }], miniPlot: [{
            type: Input
        }], pmzMax: [{
...
class MasspecPlotterLibModule {
}
MasspecPlotterLibModule.ɵmod = ɵɵdefineNgModule({ type: MasspecPlotterLibModule });
MasspecPlotterLibModule.ɵinj = ɵɵdefineInjector({ factory: function MasspecPlotterLibModule_Factory(t) { return new (t || MasspecPlotterLibModule)(); }, imports: [[]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(MasspecPlotterLibModule, { declarations: [MasspecPlotterLibComponent], exports: [MasspecPlotterLibComponent] }); })();
/*@__PURE__*/ (function () { ɵsetClassMetadata(MasspecPlotterLibModule, [{
        type: NgModule,
        args: [{
...
export { MasspecPlotterLibComponent, MasspecPlotterLibModule };
//# sourceMappingURL=masspec-plotter-lib.js.map
